...
const translations = {
  en: {
    ...
    resendIn: ({ sec }) => `Resend in ${sec}s`,
    invalidPhone: 'Enter a valid phone number with country code',
    phoneSendError: 'Could not send code. Try again.',
    ...
    budgetNotes: 'Notes',
    budgetNotesPlaceholder: 'Optional note…',
    budgetSpent: 'Spent',
    ...
    notifEnableAllDesc: 'Turn off to silence all notifications',
    notifBudgets: 'Budget alerts',
    notifBudgetsDesc: 'Warn when nearing or exceeding a budget',
    notifGoals: 'Goal progress',
    notifGoalsDesc: 'Celebrate milestones and completions',
    notifSubscriptions: 'Subscription reminders',
    notifSubscriptionsDesc: 'Heads-up before a charge',
    notifRecurring: 'Recurring reminders',
    notifRecurringDesc: 'Reminders for scheduled transactions',
  ...
  tr: {
    ...
    resendIn: ({ sec }) => `${sec} sn sonra tekrar gönder`,
    invalidPhone: 'Ülke kodu ile geçerli bir telefon numarası girin',
    phoneSendError: 'Kod gönderilemedi. Tekrar deneyin.',
    ...
    budgetNotes: 'Not',
    budgetNotesPlaceholder: 'İsteğe bağlı not…',
    ...
    landingFeaturesLabel: 'Özellikler',
    editBtn: 'Düzenle',
    ...
    notifEnableAll: 'Bildirimleri aç',
    notifEnableAllDesc: 'Tüm bildirimleri susturmak için kapatın',
    notifBudgets: 'Bütçe uyarıları',
    notifBudgetsDesc: 'Bütçeye yaklaşırken veya aşarken uyarır',
    notifGoals: 'Hedef ilerlemesi',
    notifGoalsDesc: 'Önemli adımları ve tamamlamayı kutlar',
    notifSubscriptions: 'Abonelik hatırlatmaları',
    notifSubscriptionsDesc: 'Çekim öncesi bilgilendirir',
    notifRecurring: 'Tekrarlayan hatırlatma',
    notifRecurringDesc: 'Planlanan işlemler için hatırlatma',
    ...
    exportCsv: 'CSV İndir',
    exportCsvToast: 'CSV dışa aktarıldı',
