...
const translations = {
  en: {
    ...
    landingSubtitle: 'Log income and expenses, track subscriptions, and reach your savings goals.',
    landingGetStarted: 'Create free account',
    landingSignIn: 'Sign in',
    landingFeature1Title: 'Add a transaction in seconds',
    landingFeature1Desc: 'Type a description, enter the amount, pick a category.',
    landingFeature2Title: 'See your spending at a glance',
    landingFeature2Desc: 'Dashboard shows balance, recent activity, and monthly breakdown.',
    landingFeature3Title: 'Set savings goals',
    landingFeature3Desc: 'Create goals and watch the progress bar fill up as you save.',
    landingFeature4Title: 'Track subscriptions',
    landingFeature4Desc: 'Never lose track of recurring services and billing dates.',
  ...
  tr: {
    ...
    landingSubtitle: 'Gelir ve giderlerini kaydet, abonelikleri takip et, hedeflerine ulaş.',
    landingGetStarted: 'Ücretsiz hesap oluştur',
    landingSignIn: 'Giriş yap',
    landingFeature1Title: 'Saniyeler içinde işlem ekle',
    landingFeature1Desc: 'Açıklama yaz, tutarı gir, kategori seç.',
    landingFeature2Title: 'Harcamalarını tek bakışta gör',
    landingFeature2Desc: 'Özet ekranı bakiye, son işlemler ve aylık dağılımı gösterir.',
    landingFeature3Title: 'Birikim hedefleri belirle',
    landingFeature3Desc: 'Hedef oluştur, biriktirdikçe ilerleme çubuğunun dolduğunu izle.',
    landingFeature4Title: 'Abonelikleri takip et',
    landingFeature4Desc: 'Tekrarlayan hizmetleri ve fatura tarihlerini asla kaçırma.',
    landingCtaTitle: 'Bugün takibe başla.',
